...
class Topics:
    ...
    def main_menu(self):
        ...
        print("1)   Module 1 --> Intro to Security")
        print("2)   Module 2 --> Threat Management")
        print("3)   Module 3 --> Threats & Attacks on Endpoints")
        print("4)   Module 4 --> Endpoint & APP security")
        print("5)   Module 5 --> Mobile, Embedded & Specialized Devices")
        print("6)   Module 6 --> Cryptography")
        print("7)   Module 7 --> PKI & Cryptographic Protocols")
        print("8)   Module 8 --> Networking Threats")
        print("9)   Module 9 --> Network Security Apps & Tech")
        print("10)  Module 10 --> Cloud & Virtualization")
        print("11)  Module 11 --> Wireless Network Security")
        print("12)  Module 12 --> Authentication")
        print("13)  Module 13 --> Incident Prep, Response & Investigation")
        print("14)  Module 14 --> Cybersecurity Resilience")
        print("15)  Module 15 --> Risk Mgmt & Data Privacy")
